#ifndef Engine_keys_h_
#define Engine_keys_h_

#include <SDL3/SDL.h>
#include <SDL3/SDL_scancode.h>

/**
 * Massey GameEngine translation of SDL scancodes
 */
...
enum Key
{
    ...
    KEY_WAKE = SDL_SCANCODE_WAKE,

    KEY_CHANNEL_INCREMENT = SDL_SCANCODE_CHANNEL_INCREMENT,
    KEY_CHANNEL_DECREMENT = SDL_SCANCODE_CHANNEL_DECREMENT,

    KEY_MEDIA_PLAY = SDL_SCANCODE_MEDIA_PLAY,
    KEY_MEDIA_PAUSE = SDL_SCANCODE_MEDIA_PAUSE,
    KEY_MEDIA_RECORD = SDL_SCANCODE_MEDIA_RECORD,
    KEY_MEDIA_FAST_FORWARD = SDL_SCANCODE_MEDIA_FAST_FORWARD,
    KEY_MEDIA_REWIND = SDL_SCANCODE_MEDIA_REWIND,
    KEY_MEDIA_NEXT_TRACK = SDL_SCANCODE_MEDIA_NEXT_TRACK,
    KEY_MEDIA_PREVIOUS_TRACK = SDL_SCANCODE_MEDIA_PREVIOUS_TRACK,
    KEY_MEDIA_STOP = SDL_SCANCODE_MEDIA_STOP,
    KEY_MEDIA_EJECT = SDL_SCANCODE_MEDIA_EJECT,
    KEY_MEDIA_PLAY_PAUSE = SDL_SCANCODE_MEDIA_PLAY_PAUSE,
    KEY_MEDIA_SELECT = SDL_SCANCODE_MEDIA_SELECT,

    KEY_AC_NEW = SDL_SCANCODE_AC_NEW,
    KEY_AC_OPEN = SDL_SCANCODE_AC_OPEN,
    KEY_AC_CLOSE = SDL_SCANCODE_AC_CLOSE,
    KEY_AC_EXIT = SDL_SCANCODE_AC_EXIT,
    KEY_AC_SAVE = SDL_SCANCODE_AC_SAVE,
    KEY_AC_PRINT = SDL_SCANCODE_AC_PRINT,
    KEY_AC_PROPERTIES = SDL_SCANCODE_AC_PROPERTIES,
    ...
    KEY_RESERVED = SDL_SCANCODE_RESERVED,
